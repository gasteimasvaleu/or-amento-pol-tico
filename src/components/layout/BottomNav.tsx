import { Home, LayoutDashboard, Receipt, CalendarDays, Menu, X, LogOut, ImageIcon, LifeBuoy, Newspaper, Vote, Users, Building2, Heart, Shield, Bell, Crown } from "lucide-react";
...
export function BottomNav() {
  ...
  return (
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border pb-[env(safe-area-inset-bottom)]" style={{ WebkitTransform: 'translateZ(0)', willChange: 'transform' }}>
